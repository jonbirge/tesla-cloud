(function() {
    ...
    // New getter to expose weatherData
    function getWeatherData() {
        return weatherData;
    }

    // Expose public API via module
    const WeatherModule = {
        getMoonPhaseName,
        switchWeatherImage,
        fetchWeatherData,
    ...
    // Also assign global aliases for backward compatibility
    window.getMoonPhaseName = getMoonPhaseName;
    window.switchWeatherImage = switchWeatherImage;
    window.fetchWeatherData = fetchWeatherData;
    window.showHourlyForecast = showHourlyForecast;
    window.closeHourlyForecast = closeHourlyForecast;
